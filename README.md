# estúdio hacker
Grupo multidisciplinar que realiza atividades tecnológicas e artísticas, baseados na filosofia hacker e na abordagem pedagógica Aprendizagem Criativa.
...
Mais informações na [página do SESC](https://www.sescsp.org.br/programacao/184178_MAQUINA+BOTANICA+DE+GOLDBERG+SISTEMA+DE+IRRIGACAO+AUTOMATICA).
...
### Festival de Invenção e Criatividade em Itatiba

No dia 4 de dezembro de 2018, João Adriano Freitas realizou oficinas de Introdução a Computação Criativa com Scratch e BBC micro:bit no Festival de Invenção e Criatividade em Itatiba. O FIC é uma grande celebração do espírito inventivo, colaborativo e mão na massa da educação brasileira. Nele, crianças, jovens, seus familiares e educadores tem a oportunidade de explorar materiais e tecnologias high e low tech, participar de atividades e aprender de forma estimulante e descontraída. O Festival tem como objetivos divulgar, inspirar e facilitar a implementação de atividades de aprendizagem mão na massa em ambientes educacionais formais e não formais de todo o país.

Mais informações na [página do evento](http://portal.itatiba.sp.gov.br/servicos/festi/).
...
### LET's GO Festival 2018

No dia 25 de setembro de 2018, em Curitiba (PR), aconteceu o LET's GO Festival onde João Adriano Freitas fez a apresentação "Para além do currículo com VC.Maker e BBC Micro:bit".

Mais informações em breve.

Informações na [página do evento](https://www.facebook.com/events/2087249918270427/).
...
* [Lousa Mágica](https://www.sescsp.org.br/programacao/149064_LOUSA+MAGICA);
...
Entre os dias 5 e 7 de outubro de 2017, Allan Moreira, João Adriano Freitas e Maurício Mudrik apresentaram os projetos a seguir na mostra interativa:
* #RoboPisca no Scratch;
* Manhã de Robobagens;
* Computação física com Scratch e BBC micro:bit

Mais informações na [página da conferência](https://docs.google.com/document/d/e/2PACX-1vTQwDXlupW8OVtXCuGOgqkb3Vu2f8LRxLFIA1l1BCmEKqlLNXgHTT8vuodV8m0x0K0FQsdHU467PHLk/pub).
